    ...
    <header className="border-b border-[#e9e9e9] bg-white">
      <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 md:px-20">
        <Link to="/" className="flex items-center gap-2">
          ...
          />
          <span className="text-sm font-bold text-[#001931] md:text-base">
            HERO.IO
          </span>
        </Link>
        ...
        <button className="rounded bg-linear-to-r from-[#632EE3] to-[#9f62f2] px-4 py-2 text-sm font-semibold text-white flex justify-center items-center gap-2">
